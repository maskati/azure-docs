...
> Azure Container Apps allows you to run containerized applications without worrying about orchestration or infrastructure.
  ...
  - Get started
    ...
    - Quickstarts
      ...
      - Deploy Functions
        - [Azure portal](https://learn.microsoft.com/en-us/azure/container-apps/functions-usage?pivots=azure-portal)
        - [Command line](https://learn.microsoft.com/en-us/azure/container-apps/functions-usage?pivots=azure-cli)
      - Run a job
  ...
  - Develop & deploy
    ...
    - Use Azure Functions
      ...
      - [Manage a Functions app through the portal and CLI](https://learn.microsoft.com/en-us/azure/container-apps/functions-usage)
