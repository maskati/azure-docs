...
> Learn how to use Azure Virtual Network. Quickstarts, tutorials, samples, and more, show you how to deploy a virtual network, control traffic filtering and routing, and connect a virtual network to other virtual networks.
  ...
  - Troubleshoot
    ...
    - [Test network latency between Azure VMs](https://learn.microsoft.com/troubleshoot/azure/virtual-network/virtual-network-test-latency?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
    - [Test VM network throughput by using NTTTCP](https://learn.microsoft.com/troubleshoot/azure/virtual-network/virtual-network-bandwidth-testing?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
    - [Troubleshoot Azure VM connectivity problems](https://learn.microsoft.com/troubleshoot/azure/virtual-network/troubleshoot-vm-connectivity?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
    - [Troubleshoot outbound SMTP connectivity problems](https://learn.microsoft.com/troubleshoot/azure/virtual-network/troubleshoot-outbound-smtp-connectivity?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
    - [Troubleshoot virtual network peering issues](https://learn.microsoft.com/troubleshoot/azure/virtual-network/virtual-network-troubleshoot-peering-issues?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
    - [Troubleshoot connectivity problems between Azure VMs](https://learn.microsoft.com/troubleshoot/azure/virtual-network/virtual-network-troubleshoot-connectivity-problem-between-vms?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
    - [Troubleshoot virtual network deletion failures](https://learn.microsoft.com/troubleshoot/azure/virtual-network/virtual-network-troubleshoot-cannot-delete-vnet?toc=%2Fazure%2Fvirtual-network%2Ftoc.json)
  - Reference
