...
> Learn how to use API Management to publish APIs to external, partner, and employee developers securely and at scale. Create and manage modern API gateways for existing back-end services hosted anywhere.
  ...
  - Deployment and operations
    ...
    - Network isolation
      ...
      - [VNet injection service - requirements](https://learn.microsoft.com/en-us/azure/api-management/virtual-network-injection-resources)
      - [VNet integration workspace gateway - requirements](https://learn.microsoft.com/en-us/azure/api-management/virtual-network-workspaces-resources)
      - [Deploy to a VNet - external](https://learn.microsoft.com/en-us/azure/api-management/api-management-using-with-vnet)
      - [Deploy to a VNet - internal](https://learn.microsoft.com/en-us/azure/api-management/api-management-using-with-internal-vnet)
      - [Integrate Application Gateway in an internal virtual network](https://learn.microsoft.com/en-us/azure/api-management/api-management-howto-integrate-internal-vnet-appgateway)
      - [Connect privately using private endpoint](https://learn.microsoft.com/en-us/azure/api-management/private-endpoint)
      - [Integrate with VNet for outbound requests](https://learn.microsoft.com/en-us/azure/api-management/integrate-vnet-outbound)
