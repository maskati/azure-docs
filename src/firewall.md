...
> Learn how to deploy Azure Firewall, a cloud-based network security service.
  ...
  - Design & architecture
    - [Reliability in Azure Firewall](https://learn.microsoft.com/azure/reliability/reliability-firewall?toc=/azure/firewall/toc.json&bc=/azure/firewall/breadcrumb/toc.json)
    - Policy
