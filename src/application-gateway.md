...
> Learn how to create application gateways. This documentation helps you plan, deploy, and manage web traffic to your Azure resources.
  ...
  - Troubleshoot
    - [ILB with an App Service Environment](https://learn.microsoft.com/troubleshoot/azure/application-gateway/create-gateway-internal-load-balancer-app-service-environment?toc=/azure/application-gateway/toc.json)
    - [App service issues](https://learn.microsoft.com/troubleshoot/azure/application-gateway/troubleshoot-app-service-redirection-app-service-url?toc=/azure/application-gateway/toc.json)
    - [Session affinity issues](https://learn.microsoft.com/troubleshoot/azure/application-gateway/how-to-troubleshoot-application-gateway-session-affinity-issues?toc=/azure/application-gateway/toc.json)
    - [Bad Gateway 502 errors](https://learn.microsoft.com/troubleshoot/azure/application-gateway/application-gateway-troubleshooting-502?toc=/azure/application-gateway/toc.json)
    - [HTTP response codes](https://learn.microsoft.com/troubleshoot/azure/application-gateway/http-response-codes?toc=/azure/application-gateway/toc.json)
    - [Mutual authentication](https://learn.microsoft.com/troubleshoot/azure/application-gateway/mutual-authentication-troubleshooting?toc=/azure/application-gateway/toc.json)
    - [Ingress for AKS](https://learn.microsoft.com/troubleshoot/azure/application-gateway/ingress-controller-troubleshoot?toc=/azure/application-gateway/toc.json)
    - [Resource Health](https://learn.microsoft.com/troubleshoot/azure/application-gateway/resource-health-overview?toc=/azure/application-gateway/toc.json)
    - [Use Log Analytics](https://learn.microsoft.com/troubleshoot/azure/application-gateway/log-analytics?toc=/azure/application-gateway/toc.json)
    - [Backend health issues](https://learn.microsoft.com/troubleshoot/azure/application-gateway/application-gateway-backend-health-troubleshooting?toc=/azure/application-gateway/toc.json)
    - [Key Vault errors](https://learn.microsoft.com/troubleshoot/azure/application-gateway/application-gateway-key-vault-common-errors?toc=/azure/application-gateway/toc.json)
    - [Disabled listeners](https://learn.microsoft.com/troubleshoot/azure/application-gateway/disabled-listeners?toc=/azure/application-gateway/toc.json)
  - Reference
