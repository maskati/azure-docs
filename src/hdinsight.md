    ...
    - How-to guides
      ...
      - Troubleshoot
        - Known issues
          ...
          - [Azure HDInsight Ambari access broken due to certificate issues post certification rotation](https://learn.microsoft.com/en-us/azure/hdinsight/hdinsight-known-issues-ambari-access-certificate-issue)
          - [Azure HDInsight headnode goes to unresponsive state](https://learn.microsoft.com/en-us/azure/hdinsight/hdinsight-known-issues-cluster-head-node-unresponsive)
          - [Azure HDInsight ESP cluster creation issues due to Ranger service startup](https://learn.microsoft.com/en-us/azure/hdinsight/hdinsight-known-issues-ranger-cluster-create-failure)
